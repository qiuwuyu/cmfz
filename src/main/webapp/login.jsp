	...
	<script type="text/javascript">
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
                $("#captchaImage").prop("src","${pageContext.request.contextPath }/getKaptcha.do?a="+new Date().getTime());
			});
...
<body>
		...
		<div class="login">
			<form id="loginForm" action="${pageContext.request.contextPath}/adminuser/login" method="post" >
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img class="yzm_img" id='captchaImage' src="${pageContext.request.contextPath }/getKaptcha" width="80" height="24px" />
							</td>
						</tr>					
					<tr>
						<td>
